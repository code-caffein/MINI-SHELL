...
SRC = execution/builtin_tools.c execution/execute.c       execution/mini_errors.c   execution/piping.c        execution/redirection.c   execution/shell_builts0.c execution/shell_builts1.c execution/var_tools_0.c   execution/var_tools_1.c \
		...
		parsing/add_helper2.c       parsing/add_utils2.c        parsing/handle_red_utils1.c  parsing/parse.c             parsing/parse_helper2.c     parsing/readline.c          parsing/tokenizer_1utils.c  parsing/tokenizer_3utils.c  parsing/tokenizer_fill2.c\
		minishell.c
